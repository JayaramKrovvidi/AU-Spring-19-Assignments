...
CREATE TABLE `assigned` (
  ...
  CONSTRAINT `assigned_ibfk_1` FOREIGN KEY (`dr_id`) REFERENCES `driving` (`dr_id`),
  CONSTRAINT `assigned_ibfk_2` FOREIGN KEY (`booking_id`) REFERENCES `booking` (`booking_id`)
...
INSERT INTO `assigned` VALUES (3,1),(1,2);
